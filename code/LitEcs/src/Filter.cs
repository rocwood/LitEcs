...
namespace LitEcs
{
	...
	public abstract class Filter
	{
		...
		protected Filter(World world, int denseCapacity, int sparseCapacity)
		{
			_world = world;
			//_mask = mask;
		...
		protected void SetInclude(bool includeAny, params int[] indices)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		protected void SetExclude(params int[] indices)
		{
			Exclude = indices;
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		protected static int idx<T>() where T : struct, IComponent => ComponentInfo<T>.index;
